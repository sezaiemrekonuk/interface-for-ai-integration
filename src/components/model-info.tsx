...
export default function ModelInfo({ modelName, modelDescription, modelImage }: { modelName: string, modelDescription: string, modelImage: string }) {
    return (
        <div className="w-[120px] flex flex-center gap-2 bg-highlight lg:p-2 rounded-full shadow-lg shadow-violet-600 mb-3 border-2 border-violet-600 cursor-pointer">
